...
__CHEETAH_genTime__ = 1450130654.685658
__CHEETAH_genTimestamp__ = 'Mon Dec 14 16:04:14 2015'
__CHEETAH_src__ = 'app_version.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Dec 14 16:00:20 2015'
...
''')
        for key, value in VFN(VFSL([locals()]+SL+[globals(), builtin],"version",True),"items",False)(): # generated from line 15, col 1
            write(u'''#define ''')
            ...
            write(u''' ''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"value",True) # u'$value' on line 16, col 15
            if _v is not None: write(_filter(_v, rawExpr=u'$value')) # from line 16, col 15.
            write(u'''
''')
        write(u'''
#endif /* _''')

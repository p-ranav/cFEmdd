...
__CHEETAH_genTime__ = 1450628227.718228
...
** Purpose: 
**  The ''')
        _v = VFFSL(SL,"application_name",True) # u'${application_name}' on line 6, col 9
...
''')
        for subversion in VFFSL(SL,"version_list",True): # generated from line 15, col 1
            write(u'''#define ''')
            _v = VFFSL(SL,"subversion",True) # u'$subversion' on line 16, col 10

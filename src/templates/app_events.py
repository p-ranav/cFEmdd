...
__CHEETAH_genTime__ = 1450199512.491981
...
__CHEETAH_srcLastModified__ = 'Tue Dec 15 11:07:35 2015'
...
''')
        for event_id in VFSL([locals()]+SL+[globals(), builtin],"event_ids_list",True): # generated from line 15, col 1
            write(u'''#define ''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"event_id",True) # u'$event_id' on line 16, col 10

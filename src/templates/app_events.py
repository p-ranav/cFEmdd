...
__CHEETAH_genTime__ = 1450132265.219399
__CHEETAH_genTimestamp__ = 'Mon Dec 14 16:31:05 2015'
__CHEETAH_src__ = 'app_events.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Dec 14 16:30:56 2015'
...
** File:
**    ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"application_name",True) # u'${application_name}' on line 3, col 7
...
''')
        for key, value in VFN(VFSL([locals()]+SL+[globals(), builtin],"event_ids",True),"items",False)(): # generated from line 15, col 1
            write(u'''#define ''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"key",True) # u'$key' on line 16, col 10
            if _v is not None: write(_filter(_v, rawExpr=u'$key')) # from line 16, col 10.
            _v = VFSL([locals()]+SL+[globals(), builtin],"value",True) # u'$value' on line 16, col 14
            if _v is not None: write(_filter(_v, rawExpr=u'$value')) # from line 16, col 14.
            write(u'''
''')
        write(u'''
#endif /* _''')
